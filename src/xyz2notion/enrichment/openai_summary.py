...
_RISK_TERM = re.compile(
    r"(?:警察|边境警察|杀生|杀人|自杀|自尽|吸毒|贩毒|毒品|毒贩|海洛因|可卡因|"
    r"大麻|鸦片|芬太尼|枪支|机关枪|开枪|枪击|枪顶|弹药|炸药|爆炸|炸弹|假证|偷渡|"
    r"走私|绑架|贩运|贩子|黑帮|尸体|死人|死尸|亡者|凶杀|凶手|血腥|色情|裸体|嫖娼|"
    r"赌博|赌场|缅甸|中缅|屠刀|砍人|被杀|冷兵器)"
)
