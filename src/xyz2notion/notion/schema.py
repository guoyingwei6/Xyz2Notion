...
VIEW_SPECS: tuple[ViewSpec, ...] = (
    ...
    ViewSpec(
        ...
        name="Episode · 在听",
        view_type="gallery",
        visible_properties=("Name", "Progress Ring", "Skip AI", "Last Played At"),
    ...
    ViewSpec(
        ...
        name="Episode · 待听",
        view_type="gallery",
        visible_properties=("Name", "Listening Status", "Published At"),
    ...
    ViewSpec(
        ...
        name="Episode · 收藏",
        view_type="gallery",
        visible_properties=("Name", "ASR Status", "Published At"),
