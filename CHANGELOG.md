...
- **MAJOR**（如 `1.0.0`、`2.0.0`）：重大里程碑，或包含不兼容的数据模型、配置或行为变化。
- **MINOR**（如 `0.2.0`、`0.3.0`）：向后兼容的新功能或完整功能模块。
- **PATCH**（如 `0.2.1`、`0.2.2`）：向后兼容的 Bug 修复、文档修正和小幅改动。
...
- README 改为简洁项目入口；配置、队列、候选门槛、Notion 视图、统计口径和安全边界等
